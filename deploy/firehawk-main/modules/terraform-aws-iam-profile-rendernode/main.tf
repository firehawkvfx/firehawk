...
module "iam_policies_s3_read_write" {
  source = "github.com/firehawkvfx/firehawk.git//deploy/firehawk-main/modules/aws-iam-policies-s3-read-write"
...
module "iam_policies_get_caller_identity" {
  source = "github.com/firehawkvfx/firehawk.git//deploy/firehawk-main/modules/aws-iam-policies-get-caller-identity"
