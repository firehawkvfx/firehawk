...
resource "aws_route53_record" "fsx_record" {
  ...
  name    = element(concat(list("fsx.${var.private_domain}"), list("")), 0)
  type    = "A"
  ttl     = 300
