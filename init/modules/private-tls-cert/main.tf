...
resource "null_resource" "ca_public_key_file_path" {
  count = md5(tls_self_signed_cert.ca.cert_pem) != filemd5(var.ca_public_key_file_path) ? 1 : 0
...
resource "null_resource" "private_key_file_path" {
  count = md5(tls_private_key.cert.private_key_pem) != filemd5(var.private_key_file_path) ? 1 : 0
...
resource "null_resource" "public_key_file_path" {
  count = md5(tls_locally_signed_cert.cert.cert_pem) != filemd5(var.public_key_file_path) ? 1 : 0
  provisioner "local-exec" {
