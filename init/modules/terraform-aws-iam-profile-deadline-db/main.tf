...
module "iam_policies_deadline_spot_fleet" {
  source      = "github.com/firehawkvfx/firehawk-main.git//modules/aws-iam-policies-deadline-spot-fleet"
...
module "iam_policies_secrets_manager_put" {
  source       = "github.com/firehawkvfx/firehawk-main.git//modules/aws-iam-policies-secrets-manager-put"
