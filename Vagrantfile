    ...
    servers.each do |machine|
        ...
        # config.vm.define machine[:hostname] do |node|
            ...
            if box_file_in.nil? || box_file_in.empty?
                ...
                node.vm.provision "shell", inline: "export DEBIAN_FRONTEND=noninteractive; sudo apt-get install -y sshpass moreutils"
                ...
                node.vm.provision "shell", inline: "cd /vagrant;  ansible-playbook -i '/vagrant/ansible/hosts' ansible/transparent-hugepages-disable.yml" # mongo requires no transparent hugepages
