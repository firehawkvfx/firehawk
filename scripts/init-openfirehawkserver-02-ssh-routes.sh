...
ansible-playbook -i "$TF_VAR_inventory" ansible/node-centos-houdini.yaml -vvv --extra-vars "variable_host=localhost variable_user=vagrant houdini_install_type=server" --skip-tags "sync_scripts"
