...
# enable promisc mode
ansible-playbook -i "$TF_VAR_inventory" ansible/init.yaml --extra-vars "variable_host=localhost delegate_host=localhost variable_user=deployuser configure_gateway=true set_hostname=firehawkgateway" --tags "init-host,init"; exit_test
# enable ipforwarding
