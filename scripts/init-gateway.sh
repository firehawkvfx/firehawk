...
# enable promisc mode
ansible-playbook -i "$TF_VAR_inventory" ansible/init.yaml --extra-vars "variable_host=localhost variable_user=deployuser configure_gateway=true set_hostname=firehawkgateway" i--tags "init-host nit"; exit_test
# enable ipforwarding
