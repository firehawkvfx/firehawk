...
python $TF_VAR_firehawk_path/scripts/replace_value.py -f $config_override 'TF_VAR_enable_vpc=' 'false' # ...Enable the vpc.
...
python $TF_VAR_firehawk_path/scripts/replace_value.py -f $config_override 'TF_VAR_taint_single=' '()' # taint var allows you to terraform taint a resource automatically when firehawk.sh runs
