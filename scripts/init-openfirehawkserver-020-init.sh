...
sudo chmod 0600 /secrets/keys/firehawkgateway_private_key
...
ansible-playbook -i "$TF_VAR_inventory" ansible/init.yaml --extra-vars "variable_host=firehawkgateway variable_user=deployuser configure_gateway=true set_hostname=firehawkgateway update_openfirehawkserver_ip_var=true"; exit_test
