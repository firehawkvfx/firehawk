...
ansible-playbook -i "$TF_VAR_inventory" ansible/node-centos-houdini.yaml -vvv --extra-vars "variable_host=workstation.firehawkvfx.com variable_user=deadlineuser sesi_password=$TF_VAR_sesi_password" --skip-tags "sync_scripts"; exit_test
eval $(ssh-agent -k)
printf "\n...Finished $SCRIPTNAME\n\n"