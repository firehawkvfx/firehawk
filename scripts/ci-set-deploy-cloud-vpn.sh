...
sed -i 's/^TF_VAR_sofnas_skip_update=.*$/TF_VAR_sofnas_skip_update=false/' $config_override
...
sed -i 's/^TF_VAR_taint_list=.*$/TF_VAR_taint_list="module.vpc.module.vpn.module.openvpn.aws_instance.openvpn[0] module.vpc.module.vpn.module.openvpn.aws_eip.openvpnip[0]"/' $config_override # taint vpn