...
# module "softnas_role" {
#   source = "./modules/softnas_role"
#   name         = "${var.softnas1_cloudformation_role_name}"
# }
...
# #todo when dependencys accross other modules are resolved, this can be fixed
# module "softnas2" {
#   source = "./modules/softnas"
#   softnas_role = "${module.softnas_role.softnas_role_output}"


#   cloudformation_stack_name = "FCB-SoftNAS2Stack"
...
#   softnas_user_password = "${var.softnas_user_password}"
#   softnas_role_name = "SoftNAS_HA_IAM2"
